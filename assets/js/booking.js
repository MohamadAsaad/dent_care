...
function initDatePicker() {
    if (typeof $.fn.datepicker !== 'undefined' && $('#date').length) {
        $("#date").datepicker({
            dateFormat: "yy-mm-dd", // تنسيق ميلادي
            minDate: 0,
...
function validatePhoneNumber(phone) {
    ...
    if (!/^05\d{9}$/.test(cleanedPhone)) {
        return {
            isValid: false,
            message: 'رقم غير صحيح! يجب أن يبدأ بـ 05 ويتكون من 11 رقماً'
        };
    }
        ...
        <div class="popup-content">
            ...
            <div class="popup-body">
                ...
                <div class="booking-detail">
                    ...
                    <span class="detail-value">${formatGregorianDate(formData.date)}</span>
                </div>
                <div class="booking-detail">
            ...
            <div class="receipt">
                ...
                <div class="details">
                    ...
                    <div class="detail-row">
                        ...
                        <div>${formatGregorianDate(formData.date)}</div>
                    </div>
                    <div class="detail-row">
...
function showError(message) {
    ...
    if (phoneField && message.includes('الجوال')) {
